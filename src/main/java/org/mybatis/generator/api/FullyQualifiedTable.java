...
public class FullyQualifiedTable {
    ...
    private String voObjectSubPackage;
    private String queryObjectName;
    private String queryObjectSubPackage;
    private String reqObjectName;
    private String reqObjectSubPackage;
    private String updateReqObjectName;
    private String updateReqObjectSubPackage;
    ...
    public FullyQualifiedTable(String introspectedCatalog,
        ...
        if (stringHasValue(domainObjectName)) {
            ...
            if (index == -1) {
                this.domainObjectName = domainObjectName+"PO";
                this.boObjectName = domainObjectName+"BO";
                this.voObjectName = domainObjectName+"VO";
                this.queryObjectName = domainObjectName+"Query";
                this.reqObjectName = domainObjectName+"Req";
                this.updateReqObjectName = domainObjectName+"UpdateReq";
            } else {
                this.domainObjectName = domainObjectName.substring(index + 1)+"PO";
                this.domainObjectSubPackage = domainObjectName.substring(0, index);
                this.boObjectName = domainObjectName.substring(index + 1)+"BO";
                this.boObjectSubPackage = domainObjectName.substring(0, index);
                this.voObjectName = domainObjectName.substring(index + 1)+"VO";
                this.voObjectSubPackage = domainObjectName.substring(0, index);

                this.queryObjectName = domainObjectName.substring(index + 1)+"Query";
                this.queryObjectSubPackage = domainObjectName.substring(0, index);

                this.reqObjectName = domainObjectName.substring(index + 1)+"Req";
                this.reqObjectSubPackage = domainObjectName.substring(0, index);

                this.updateReqObjectName = domainObjectName.substring(index + 1)+"UpdateReq";
                this.updateReqObjectSubPackage = domainObjectName.substring(0, index);
            }
        }
    ...
    public String getVoObjectName() {
        if (stringHasValue(voObjectName)) {
            return voObjectName;
        } else if (stringHasValue(runtimeTableName)) {
            return getCamelCaseString(runtimeTableName, true)+"VO";
        } else {
            return getCamelCaseString(introspectedTableName, true)+"VO";
        }
    }
    ...
    public String getQueryObjectName() {
        if (stringHasValue(queryObjectName)) {
            ...
            return getCamelCaseString(runtimeTableName, true)+"Query";
        } else {
            return getCamelCaseString(introspectedTableName, true)+"Query";
        }
    }

    public String getReqObjectName() {
        if (stringHasValue(reqObjectName)) {
            return reqObjectName;
        } else if (stringHasValue(runtimeTableName)) {
            return getCamelCaseString(runtimeTableName, true)+"Req";
        } else {
            return getCamelCaseString(introspectedTableName, true)+"Req";
        }
    }

    public String getUpdateReqObjectName() {
        if (stringHasValue(updateReqObjectName)) {
            return updateReqObjectName;
        } else if (stringHasValue(runtimeTableName)) {
            return getCamelCaseString(runtimeTableName, true)+"UpdateReq";
        } else {
            return getCamelCaseString(introspectedTableName, true)+"UpdateReq";
        }
    }
    ...
    public String getDomainObjectName() {
        ...
        return finalDomainObjectName+"PO";
    }
    ...
    public String getSubPackageForVo(boolean isSubPackagesEnabled) {
        StringBuilder sb = new StringBuilder();
        sb.append(getSubPackageForClientOrSqlMap(isSubPackagesEnabled));

        if (stringHasValue(voObjectSubPackage)) {
            sb.append('.');
            sb.append(voObjectSubPackage);
        }

        return sb.toString();
    }

    public String getSubPackageForUpdateReq(boolean isSubPackagesEnabled) {
        StringBuilder sb = new StringBuilder();
        sb.append(getSubPackageForClientOrSqlMap(isSubPackagesEnabled));

        if (stringHasValue(updateReqObjectSubPackage)) {
            sb.append('.');
            sb.append(updateReqObjectSubPackage);
        }

        return sb.toString();
    }

    public String getSubPackageForQuery(boolean isSubPackagesEnabled) {
        StringBuilder sb = new StringBuilder();
        sb.append(getSubPackageForClientOrSqlMap(isSubPackagesEnabled));

        if (stringHasValue(queryObjectSubPackage)) {
            sb.append('.');
            sb.append(queryObjectSubPackage);
        }

        return sb.toString();
    }

    public String getSubPackageForReq(boolean isSubPackagesEnabled) {
        StringBuilder sb = new StringBuilder();
        sb.append(getSubPackageForClientOrSqlMap(isSubPackagesEnabled));

        if (stringHasValue(reqObjectSubPackage)) {
            sb.append('.');
            sb.append(reqObjectSubPackage);
        }
