...
public abstract class IntrospectedTable {
    ...
    public String getBoRecordType() {
        return internalAttributes.get(InternalAttribute.ATTR_BO_RECORD_TYPE);
    }
    ...
    public String getUpdateReqRecordType() {
        return internalAttributes.get(InternalAttribute.ATTR_UPDATE_REQ_RECORD_TYPE);
    }
    /**
    ...
    public void initialize() {
        ...
        if("table".equals(this.getTableConfiguration().getProperties().getProperty("generatorType"))){
            calculateReqAttributes();
            calculateUpdateReqAttributes();
        }
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByQuery("selectByQuery");
    }
    ...
    public void setSelectByQuery(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_QUERY, s);
    }
    ...
    public String getSelectByQuery() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_QUERY);
    }
    ...
    protected void calculateJavaClientAttributes() {
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            if (this.fullyQualifiedTable.getDomainObjectName().endsWith("PO")) {
                String domainObjectName = this.fullyQualifiedTable.getDomainObjectName().substring(0, this.fullyQualifiedTable.getDomainObjectName().length() - 2);
    ...
    protected void calculateVoAttributes() {
        ...
        sb.append(pakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getVoObjectName());
    ...
    protected void calculateReqAttributes() {
        ...
        sb.append(pakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getReqObjectName());
        setReqRecordType(sb.toString());
    }
    protected void calculateUpdateReqAttributes() {
        String pakkage = calculateJavaUpdateReqPackage();
        StringBuilder sb = new StringBuilder();
        sb.setLength(0);
        sb.append(pakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getUpdateReqObjectName());
        setUpdateReqRecordType(sb.toString());
    }
    ...
    protected String calculateJavaVoPackage() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(config.getTargetPackage());
        sb.append(fullyQualifiedTable.getSubPackageForVo(isSubPackagesEnabled(config)));
        return sb.toString();
    }
    ...
    protected String calculateJavaQueryPackage() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(config.getTargetPackage());
        sb.append(fullyQualifiedTable.getSubPackageForQuery(isSubPackagesEnabled(config)));
        return sb.toString();
    }
    ...
    protected String calculateJavaReqPackage() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(config.getTargetPackage());
        sb.append(fullyQualifiedTable.getSubPackageForReq(isSubPackagesEnabled(config)));
        return sb.toString();
    }

    protected String calculateJavaUpdateReqPackage() {
        JavaUpdateReqGeneratorConfiguration config = context
                .getJavaUpdateReqGeneratorConfiguration();

        StringBuilder sb = new StringBuilder();
        sb.append(config.getTargetPackage());
        sb.append(fullyQualifiedTable.getSubPackageForUpdateReq(isSubPackagesEnabled(config)));
        return sb.toString();
    }
    ...
    protected String calculateMyBatis3XmlMapperFileName() {
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            if (this.fullyQualifiedTable.getDomainObjectName().endsWith("PO")) {
                String domainObjectName = fullyQualifiedTable.getDomainObjectName().substring(0, fullyQualifiedTable.getDomainObjectName().length() - 2);
                sb.append(domainObjectName);
            }else{
                sb.append(fullyQualifiedTable.getDomainObjectName());
            }
    ...
    public void setBoRecordType(String boRecordType) {
        internalAttributes.put(InternalAttribute.ATTR_BO_RECORD_TYPE,
                boRecordType);
    }
    public void setVoRecordType(String boRecordType) {
        internalAttributes.put(InternalAttribute.ATTR_VO_RECORD_TYPE,
                boRecordType);
    }
    public void setQueryRecordType(String boRecordType) {
        internalAttributes.put(InternalAttribute.ATTR_QUERY_RECORD_TYPE,
                boRecordType);
    }
    public void setReqRecordType(String boRecordType) {
        internalAttributes.put(InternalAttribute.ATTR_REQ_RECORD_TYPE,
                boRecordType);
    }
    public void setUpdateReqRecordType(String boRecordType) {
        internalAttributes.put(InternalAttribute.ATTR_UPDATE_REQ_RECORD_TYPE,
                boRecordType);
    }
