...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        if("table".equals(introspectedTable.getTableConfiguration().getProperties().getProperty("generatorType"))){
    ...
    protected  void addQueryData(Interface interfaze){
        AbstractJavaMapperMethodGenerator methodGenerator = new QueryDataMethodGenerator();
