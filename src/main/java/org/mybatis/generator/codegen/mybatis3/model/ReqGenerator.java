...
public class ReqGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            String hiddenApiField = properties.getProperty("add_hiddenApiField");
            String hiddenValidateField = properties.getProperty("add_hiddenValidateField");
            ...
            if(!hiddenApi){
                myCommentGenerator.addFieldApiModelComment(field,introspectedTable,introspectedColumn,"add");
            }
            if(!hiddenValid){
                myCommentGenerator.addFieldValidateComment(field,introspectedTable,introspectedColumn,"add");
            }
    ...
    private List<IntrospectedColumn> getIntrospectedColumns(){
        Properties properties = introspectedTable.getTableConfiguration().getProperties();
        String requiredFields = properties.getProperty("add_requiredField");
