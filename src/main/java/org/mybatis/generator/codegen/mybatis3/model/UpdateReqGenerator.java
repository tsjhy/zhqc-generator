...
public class UpdateReqGenerator extends AbstractJavaGenerator {
    public UpdateReqGenerator() {
        super();
    }
    @Override
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(
                introspectedTable.getUpdateReqRecordType());
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            String hiddenApiField = properties.getProperty("edit_hiddenApiField");
            String hiddenValidateField = properties.getProperty("edit_hiddenValidateField");
            ...
            if(!hiddenApi){
                myCommentGenerator.addFieldApiModelComment(field,introspectedTable,introspectedColumn,"edit");
            }
            if(!hiddenValid){
                myCommentGenerator.addFieldValidateComment(field,introspectedTable,introspectedColumn,"edit");
            }
    ...
    private List<IntrospectedColumn> getIntrospectedColumns(){
        Properties properties = introspectedTable.getTableConfiguration().getProperties();;
        String requiredFields = properties.getProperty("edit_requiredField");
        List<IntrospectedColumn> columns = introspectedTable.getAllColumns();
        List<IntrospectedColumn> pks = introspectedTable.getPrimaryKeyColumns();
        if(requiredFields != null){
            columns.removeIf(obj -> !pks.contains(obj) && !CheckFieldUtils.checkFieldContainsField(requiredFields,obj.getActualColumnName()));
        }
        return columns;
    }
