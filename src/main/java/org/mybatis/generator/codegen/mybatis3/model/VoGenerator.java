...
public class VoGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            String hiddenApiField = properties.getProperty("vo_hiddenApiField");
            ...
            if(!hiddenApi){
                myCommentGenerator.addFieldApiModelComment(field,introspectedTable,introspectedColumn,"vo");
            }
    ...
    private List<IntrospectedColumn> getIntrospectedColumns(){
        Properties properties = introspectedTable.getTableConfiguration().getProperties();
        String requiredFields = properties.getProperty("vo_requiredField");
