...
public class Context extends PropertyHolder {
    ...
    private JavaUpdateReqGeneratorConfiguration javaUpdateReqGeneratorConfiguration;
    ...
    public JavaUpdateReqGeneratorConfiguration getJavaUpdateReqGeneratorConfiguration() {
        return javaUpdateReqGeneratorConfiguration;
    }

    public void setJavaUpdateReqGeneratorConfiguration(JavaUpdateReqGeneratorConfiguration javaUpdateReqGeneratorConfiguration) {
        this.javaUpdateReqGeneratorConfiguration = javaUpdateReqGeneratorConfiguration;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (javaVoGeneratorConfiguration != null) {
            xmlElement.addElement(javaVoGeneratorConfiguration
                    .toXmlElement());
        }
